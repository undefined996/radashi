...
export class DistanceParser extends QuantityParser<
  DistanceUnit,
  DistanceShortUnit
> {
  constructor() {
...
type DistanceUnit = keyof typeof DistanceParser.units
type DistanceShortUnit = keyof typeof DistanceParser.shortUnits
type DistanceString = QuantityString<DistanceUnit, DistanceShortUnit>

class DistanceParser extends QuantityParser<DistanceUnit, DistanceShortUnit> {
  constructor() {
    super({
      units: DistanceParser.units,
      short: DistanceParser.shortUnits,
